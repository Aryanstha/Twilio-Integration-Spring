...
import com.aryanstha.springsecurityjwt.config.TwilioConfig;
...
public class OtpService {
    ...
    public String generateOtp(String phoneNo){
        ...
        String otpMessage = "Dear Customer , Your OTP is " + otp + ". Use this otp to log in to Hunt Venue Application";
